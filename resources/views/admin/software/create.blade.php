        ...
        <form class="js-Form Form" action="{{ route('software.store') }}" enctype="multipart/form-data" method="POST">
            ...
            <div class="Form--body">
                ...
                <div class="FormInput">
                    ...
                    <input class="Input" type="text" name="license_type" id="license_type" value="{{ old('license_type') }}">
                    @error('license_type')
                    <p class="has-error" style="color: red">
                        {{$message}}
                    </p>
                ...
                <div class="FormInput">
                    ...
                    <input class="Input" type="number" name="quantity" id="quantity" value="{{ old('quantity') }}">
                    @error('quantity')
                    <p class="has-error" style="color: red">
                        {{$message}}
                    </p>
                ...
                <div class="FormInput">
                    ...
                    <select class="selectFilter" type="text" name="people[]" id="people" multiple>
                        @foreach ($people as $person)
                            <option value="{{ $person->uid }}" @if(collect(old('people'))->contains($person->uid)) selected @endif>{{ $person->first_name }} {{ $person->last_name }}</option>
                        @endforeach
                    </select>
                    @error('people')
                    <p class="has-error" style="color: red">
