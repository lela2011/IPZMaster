                    ...
                    @foreach($manageableProjects as $project)
                        <li>
                            <div class="ZoraCitation">
                                ...
                                <a class="Link size-small" href="{{ route('research.show', ['research' => $project->id]) }}">
                                    {{ $project->title }}
                                </a>
                                ...
                                <div style="display: flex; margin-top: 16px">
                                    <a class="edit quickaction" href=" {{ route('research.edit', ['research' => $project->id]) }} ">
                                    ...
                                    <div style="flex: 1; display: flex; justify-content:center">
                                        <form data-project="{{ $project->title }}" class="deleteForm" action="{{ route('research.destroy', ['research' => $project->id]) }}" method="POST" style="width: 100%">
                                            @csrf
                                            @method('DELETE')
