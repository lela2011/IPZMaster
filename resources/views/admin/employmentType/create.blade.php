<x-layout>
    ...
    <section class="ContentArea">
        ...
        <form class="Form js-Form" method="POST" action="{{route('admin.employment-type.store')}}">
            @csrf
                ...
                <div class="FormInput">
                    ...
                    <div class="Options js-OptionInput">
                        <div class="OptionInput">
                            <input type="checkbox" id="has_personal_page" name="has_personal_page" value="1">
