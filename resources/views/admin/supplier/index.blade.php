<x-layout>
    <div class="ContentArea">
        ...
        <div class="TextImage" style="display: flex; justify-content: space-between; flex-wrap: wrap;">
            ...
            <a href="{{ route('supplier.create') }}" class="Button color-border-white size-large"
                style="margin-bottom: 8px">
                Add new Supplier
        ...
        <div class="TextImage">
                        ...
                        @foreach ($suppliers as $supplier)
                            <tr>
                                <td style="text-align: center">
                                    <a href="{{ route('supplier.edit', $supplier->id) }}" class="quickaction-anchor edit">
                                ...
                                <td style="text-align: center">
                                    <form class="deleteForm" data-name="{{ $supplier->name }}" action="{{ route('supplier.destroy', $supplier->id) }}" method="POST">
                                        @csrf
                                        @method('DELETE')
            ...
            {{ $suppliers->withQueryString()->links('pagination.uzh-pagination-en') }}
        </div>
    </div>
</x-layout>
<script>
    $(document).ready(function() {
        ...
        $('.delete').on('click', function() {
            ...
            // opens confirmation modal
            customConfirm('Are you sure you want to delete the supplier <b style="font-weight: bold;">' + name + '</b>?')
