        ...
        <form class="js-Form Form" action="{{ route('computer.store') }}" enctype="multipart/form-data" method="POST">
            ...
            <div class="Form--body">
                ...
                <div class="FormInput">
                    ...
                    <input class="Input" type="text" name="mac_address" id="mac_address" value="{{ old('mac_address') }}">
                    @error('mac_address')
                    <p class="has-error" style="color: red">
                        {{$message}}
                    </p>
                ...
                <div class="FormInput">
                    ...
                    <input class="Input" type="text" name="cpu" id="cpu" value="{{ old('cpu') }}">
                    @error('cpu')
                    <p class="has-error" style="color: red">
                        {{$message}}
                    </p>
                ...
                <div class="FormInput">
                    ...
                    <input class="Input" type="text" name="ram" id="ram" value="{{ old('ram') }}">
                    @error('ram')
                    <p class="has-error" style="color: red">
                        {{$message}}
                    </p>
                ...
                <div class="FormInput">
                    ...
                    <select class="selectFilter" name="keyboard_layout_id" id="keyboard_layout_id">
                        ...
                        @foreach ($keyboardLayouts as $keyboardLayout)
                            <option value="{{ $keyboardLayout->id }}" @if($keyboardLayout->id == old('keyboard_layout_id')) selected @endif>{{ $keyboardLayout->name }}</option>
                        @endforeach
                    </select>
